...
export const usersToSeed: UserSeed[] = [
  {
    fullName: 'Admin MakerUp',
    email: 'admin@MakerUp.com',
    password: 'admin123456',
    role: UserRole.ADMIN,
    bio: 'Administrador de la plataforma MakerUp. Apasionado de la impresión 3D desde 2015.',
